...
const DrawerContext = createContext<{ isOpen: boolean; open: () => void }>({
  isOpen: false,
  open: () => {},
});
  ...
  return (
    <Box component={"nav"} sx={{ flexShrink: { sm: 0 } }}>
      <DrawerContext.Provider value={{ open, isOpen: visible }}>
        ...
        >
          <DrawerHeader />
          <Box sx={{ textAlign: "center", minHeight: 64 }}>{drawer}</Box>
        </Drawer>
